      ...
      <div className={"admin_nav_adjustment"}>
        ...
        <div className={styles.nav_orders}>
          <ul>
            ...
            <li
              className={view === "Pending" ? styles.active : styles.notactive}
              onClick={() => {
                setView("Pending");
              }}
            >
            ...
            <li
              className={view === "Completed" ? styles.active : styles.notactive}
              onClick={() => {
                setView("Completed");
              }}
            >
            ...
            <li
              className={view === "Cancelled" ? styles.active : styles.notactive}
              onClick={() => {
                setView("Cancelled");
              }}
            >
              ...
              return (
                <React.Fragment key={index}>
                  <tr>
                    ...
                    <td className={styles.first_table_td}>
                      {item.address.address} {item.address.city}, {item.address.state}, {item.address.pincode}
                    </td>
                    <td className={styles.first_table_td}>{item.createdAt.split("T")[0]}</td>
                    <td className={styles.first_table_td}>{item.totalAmount}</td>
                    <td className={styles.first_table_td}>
                      {item.paymentStatus === "paid" ? (
                        <p className={styles.paid}>
                          <FontAwesomeIcon icon={faCheck} /> {item.paymentStatus}
                        </p>
                      ) : (
                        <p className={styles.unpaid}>
                          <FontAwesomeIcon icon={faTimes} /> {item.paymentStatus}
                        </p>
                      )}
                    </td>
                    <td className={styles.first_table_td}>
                      {item.status === "completed" ? (
                        ...
                        <p className={styles.pending}>
                          <FontAwesomeIcon icon={faSpinner} className="fa-spin" /> {item.status}
                        </p>
                      ) : (
                    ...
                    <td className={styles.first_table_td}>
                      <div className={styles.down_arrow} onClick={() => toggleRow(index)}>
                        ...
                        <div className={styles.collapsed_div}>
                          <div>
                            <div className={styles.collapsed_div_products}>
                              <p style={{ margin: "10px 0px", color: "grey" }}>Ordered Id: {item._id}</p>
                              <h6 style={{ textAlign: "center" }}>PRODUCTS</h6>
                              <table className={styles.table2}>
                                <thead>
                                  <tr>
                                    <th className={styles.second_table_th}>PRODUCT</th>
                                    <th className={styles.second_table_th}>QUANTITY</th>
                                    <th className={styles.second_table_th}>PRICE</th>
                                  </tr>
                                </thead>
                                <tbody>
                                    ...
                                    return (
                                      <tr>
                                        <td className={`${styles.second_product_td} ${styles.second_p_td}`}>
                                          <Image src={i.image} alt="image" width={100} height={100} />
                                          <p>{i.title}</p>
                                        </td>
                            ...
                            <div className={styles.collapsed_div_address}>
                              ...
                              <table className={styles.table3}>
                                ...
                                <tbody>
                                  ...
                                  <td className={styles.table3_td}>{item.address.phoneNumber}</td>
                                  <td className={styles.table3_td}>{item.email}</td>
                                  <td className={styles.table3_td}>{item.address.address}</td>
                                  <td className={styles.table3_td}>{item.address.city}</td>
                                  <td className={styles.table3_td}>{item.address.pincode}</td>
                                  <td className={styles.table3_td}>{item.address.state}</td>
                                  <td className={styles.table3_td}>{item.address.country}</td>
                                </tbody>
                              </table>
                            </div>
                          </div>
                          <div>
                            <table className={styles.table4}>
                              <thead>
                                <tr>
                                  <th className={styles.table4_th}>TOTAL PRICE</th>
                                  <td className={styles.table4_td}>Rs. {item.totalAmount}</td>
                                  <td className={styles.table4_td}></td>
                                </tr>
                                <tr>
                                  <th className={styles.table4_th}>PAYMENT STATUS</th>
                                    ...
                                    {edit1 ? (
                                      <select
                                        ...
                                        onChange={(e) => {
                                          ...
                                          updatedOrders[index].paymentStatus = e.target.value;
                                  ...
                                  <td className={styles.table4_td}>
                                    {item.paymentStatus === "paid" && !edit1? (
                                      <button className={styles.table4_td_dsb} disabled>
                                        Disabled
                                      </button>
                                    ) : edit1 ? (
                                      <button className={styles.table4_td_btn_save} onClick={() => handleSave(index)}>
                                        Save
                                      </button>
                                    ) : (
                                      <button className={styles.table4_td_btn} onClick={() => toggleEdit1(index)}>
                                        Edit
                                      </button>
                                    )}
                                  </td>
                                  <td className={styles.table4_td}>
                                    {edit1 ? (
                                      <button className={styles.table4_td_btn_close} onClick={() => toggleEdit1(index)}>
                                        Close
                                      </button>
                                    ) : (
                                      <></>
                                ...
                                <tr>
                                  <th className={styles.table4_th}>ORDER STATUS</th>
                                  <td className={styles.table4_td}>
                                    {edit2 ? (
                                      <select
                                        className={styles.table4_inp}
                                        ...
                                        onChange={(e) => {
                                          const updatedOrders:any = [...orders];
                                          updatedOrders[index].status = e.target.value;
                                          setOrders(updatedOrders);
                                        }}
                                      >
                                  ...
                                  <td className={styles.table4_td}>
                                    {item.status === "completed" && !edit2? (
                                      ...
                                      <button className={styles.table4_td_btn} onClick={() => toggleEdit2(index)}>
                                        Edit
                                      </button>
                                    )}
                                  </td>
                                  <td className={styles.table4_td}>
                                    {edit2 ? (
                                      <button className={styles.table4_td_btn_close} onClick={() => toggleEdit2(index)}>
                                        Close
                                      </button>
                                    ) : (
                                      <></>
