...
const DetailedProduct = () => {
  ...
  useEffect(() => {
    if (ProductId) {
      axios.get<ProductData>(`../api/products/${ProductId}`)
        .then((res) => {
            ...
            <div className={styles.bottom_bar}>
              <div className={styles.bottom_bar_container}>
                <div className={styles.bottom_bar_container_left}>
                  <Image src={imageSlideshow.img1} onClick={() => { setMainImage(imageSlideshow.img1) }} alt="" width={1000} height={1000} />
                  <div>
          ...
          <div className={styles.detailed_product_page}>
            <div className={styles.detailedproduct_main_content}>
              <div className={styles.imageshow_block}>
                <div className={styles.imageshow_block_left}>
                  <div className={styles.imageshow_block_left_images}><Image style={{ width: "100%", height: "auto" }} src={`${imageSlideshow.img1}`} onClick={() => { setMainImage(imageSlideshow.img1) }} alt="" width={5000} height={5000} /></div>
                  <div className={styles.imageshow_block_left_images}><Image style={{ width: "100%", height: "auto" }} src={imageSlideshow.img2} onClick={() => { setMainImage(imageSlideshow.img2) }} alt="" width={5000} height={5000} /></div>
                  <div className={styles.imageshow_block_left_images}><Image style={{ width: "100%", height: "auto" }} src={imageSlideshow.img3} onClick={() => { setMainImage(imageSlideshow.img3) }} alt="" width={5000} height={5000} /></div>
                  <div className={styles.imageshow_block_left_images}><Image style={{ width: "100%", height: "auto" }} src={imageSlideshow.img4} onClick={() => { setMainImage(imageSlideshow.img4) }} alt="" width={5000} height={5000} /></div>
                </div>
            ...
            <div className={styles.blog_comment_section}>
              ...
              {commentingState ? (
                ...
                <button className={styles.comment_section_addacomment} onClick={() => { setCommentingState(!commentingState) }}>Add a comment</button>
              )}
              {commentingState ? (
                <form className={styles.blogcommentform} onSubmit={userSubmit}>
                  ...
                  <div>
                    ...
                    {commentingState ? (
                      <button className={styles.comment_section_close} onClick={() => { setCommentingState(!commentingState) }}>Close</button>
                    ) : (
                      <></>
                    )}
                  </div>
              ...
              {pageComments.length !== 0 ? (
                ...
                <p className={styles.no_comments_block}>No comments! Be the first to add a comment.</p>
              )}
            </div>
          </div>
          <Footer />
